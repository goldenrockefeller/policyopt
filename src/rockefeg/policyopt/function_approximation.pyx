...
cdef class RobustFunctionApproximator(DifferentiableFunctionApproximator):
    ...
    cpdef copy(self, copy_obj = None):
        ...
        new_approximator.__line_search_change_rate = (
            self.__line_search_change_rate)
    ...
    cpdef void batch_update(self, entries) except *:
        ...
        cdef object entries_item_type
        cdef double learning_rate
        cdef double line_search_change_rate
        ...
        line_search_change_rate = self.line_search_change_rate()
        ...
        for entry in entries_cy:
            ...
            if line_search_loss < loss and line_search_alignment >= 0.:
                line_search_step_size *= line_search_change_rate
            ...
            nes_loss = dot_product(line_search_error, line_search_error)
    ...
    cpdef double line_search_change_rate(self) except *:
        return self.__line_search_change_rate

    cpdef void set_line_search_change_rate(
            self,
            double line_search_change_rate
            ) except *:
        self.__line_search_change_rate = line_search_change_rate
...
cdef void init_RobustFunctionApproximator(
    ...
    approximator.__line_search_change_rate = 1.618 # Golden Ratio
    approximator.__line_search_step_size = 1.

    approximator.__nes_size_growth_rate = 0.25
    approximator.__nes_direction_growth_rate = 0.25
    approximator.__nes_size_shrink_rate = 0.125
    approximator.__nes_direction_shrink_rate = 0.
